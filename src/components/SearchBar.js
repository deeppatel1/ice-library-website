...
export default class SearchBar extends Component {
    ...
    update_query(e) {
        ...
        this.props.update_query_func(e.target.value)
    }
            ...
            <div class="container flex flex-wrap justify-around items-center mx-auto">
                ...
                <div class="flex items-center">
                    <div class="relative mr-3 md:mr-0 md:block w-96">
                        ...
                        <input type="text" value={this.state.query} onChange={(e) => {this.update_query(e)}} class="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..."/>
                    </div>
